...
<div id="wrapper">
	...
	<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="{{ url ('') }}">Cadastro Owner</a>
		</div>
		<!-- /.navbar-header -->
				...
				<ul class="nav" id="side-menu">
					...
					<li {{ (Request::is( '/') ? 'class="active"' : '') }}>
                        ...
                        {{--  <li {{ (Request::is( '*charts') ? 'class="active"' : '') }}>
                            <a href="{{ url ('charts') }}">
                                <i class="fa fa-bar-chart-o fa-fw"></i> Charts</a>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li {{ (Request::is( '*documentation') ? 'class="active"' : '') }}>
                            <a href="{{ url ('documentation') }}">
                                <i class="fa fa-file-word-o fa-fw"></i> Documentation</a>
                        </li>  --}}

					<li {{ (Request::is( '*owner') ? 'class="active"' : '') }} >
						<a href="#">
						...
						<ul class="nav nav-second-level">
							<li>
								<a href="{{ url('/owner/gestor/list') }}">Gestores</a>
							</li>
							<li>
					...
					<li {{ (Request::is( '*franchise') ? 'class="active"' : '') }}>
						...
						<ul class="nav nav-second-level">
							...
							<li>
                                <a href="#">Franquia 2 <span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                        <li>
                                            <a href="#">Gestores</a>
                                        </li>
							...
							<li>
                                <a href="#">Franquia 3 <span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                        <li>
                                            <a href="#">Gestores</a>
                                        </li>
							...
							<li>
                                <a href="#">Franquia N <span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                        <li>
                                            <a href="#">Gestores</a>
                                        </li>
